  ...
  const state = {
    ...
    skills: [
      ...
      },
      {
        ...
        description: t("common:skills.frontend.description"),
      ...
      },
      {
        ...
        description: t("common:skills.html.description"),
        tools: ["HTML", "CSS", "Less", "SCSS", "PostCSS", "TailwindCSS"],
        matrix: false,
      },
      {
        title: t("common:skills.dev.title"),
        description: t("common:skills.dev.description"),
    ...
    career: [
      {
        title: t("common:career.pixelpoint.title"),
        url: "https://pixelpoint.io",
        link: true,
        position: t("common:career.pixelpoint.position"),
        description: t("common:career.pixelpoint.description"),
        devStack: ["JavaScript", "React", "Next", "Gatsby", "TypeScript", "GraphQL", "HTML", "CSS", "TailwindCSS"],
        designStack: [],
        date: `${ucFirst(getFormatJobDate("2023-04-25", lang))} — ${t("common:now")}, ${getDiffJobDate("2023-04-25", new Date(), lang)}`,
      },
      {
